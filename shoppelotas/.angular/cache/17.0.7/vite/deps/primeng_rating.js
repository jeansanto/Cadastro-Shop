...
function Rating_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction1(10, _c0, ctx_r3.focusedOptionIndex() === 0 && ctx_r3.isFocusVisible));
    ɵɵattribute("data-pc-section", "cancelItem");
    ɵɵadvance(1);
    ɵɵattribute("data-p-hidden-accessible", true);
    ɵɵadvance(1);
    ɵɵproperty("name", ctx_r3.name)("checked", ctx_r3.value === 0)("disabled", ctx_r3.disabled)("readonly", ctx_r3.readonly);
...
function Rating_ng_container_1_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction2(9, _c1, star_r12 + 1 <= ctx_r4.value, star_r12 + 1 === ctx_r4.focusedOptionIndex() && ctx_r4.isFocusVisible));
    ɵɵadvance(1);
    ɵɵattribute("data-p-hidden-accessible", true);
    ɵɵadvance(1);
    ɵɵproperty("name", ctx_r4.name)("checked", ctx_r4.value === 0)("disabled", ctx_r4.disabled)("readonly", ctx_r4.readonly);
